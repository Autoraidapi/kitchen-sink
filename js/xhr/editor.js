(function () {
  ...
  //  input = typeof command !== 'undefined' ? prompt('Value for : ') : '';
  ...
  //}
	...
	function replaceFields (nFlag) {
		...
		if (nReady !== 3) { return; }
		for (
			var oField, nItem = 0, aTextareas = [].slice.call(document.getElementsByTagName("textarea"), 0);
	...
	oToolsReq.open("GET", "../json/editor.json", true);
	oToolsReq.send(null);
